...
. Wir wollen view.js as Programmierspraceh nutzen, da es nach einer vielversprechenden Möglichkeit aussieht.
. Die Haupsächlich benutzt Sprache zur Umsetzung ist Java, da mir ihr die meisten Teammitglieder vertraut ist.
