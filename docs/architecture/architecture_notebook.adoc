...
link:https://vuejs.org/[Vue.js] ist ein modernes Framework zum bauen von Web-Anwendungen.
Es ist den meisten Team-Mitgliedern bekannt und wird für dieses Projekt genutzt.
