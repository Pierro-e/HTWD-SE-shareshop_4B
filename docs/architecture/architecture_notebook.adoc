...
- Team besitzt Kenntnisse in php und Java, daher ist php oder Spring Boot als Framework sinnvoll
...
- Backend wird mit php oder Spring Boot entwickelt, um REST-API zur Verfügung zu stellen
...
- *backend (REST-API) läuft auf einem Server
