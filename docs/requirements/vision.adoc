= Vision: {project-name}
Erik Wenke <erik.wenke@stud.htw-dresden.d>; Vorname2 Nachname2 <email2@domain.org>; Vorname3 Nachname3 <email3@domain.org>
{localdatetime}
...
| Auftraggeber / Pfrüfer
// TODO: Beschreibung & Ziele + Bezug zum Projekt
|
|
| Coach
// TODO: Bezug zum Projekt
|
| Sorgt dafür, dass notwendiges Wissen aufbereitet zu Verfügung steht. Leitet Projekt durch seine gesamelten Erfahrungswerte.
|Scrum Team
// TODO: Beschreibung & Ziele + Bezug zum Projekt
|
|
