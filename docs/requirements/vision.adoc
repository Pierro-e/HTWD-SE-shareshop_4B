= Vision: {project-name}
Erik Wenke <erik.wenke@stud.htw-dresden.de>; Maximilian Paul <s87085@htw-dresden.de>; Marlene Fritz <s87181@htw-dresden.de>; Levin Heirich <s87139@htw-dresden.de>; Pierre Kißling <s86388@htw-dresden.de>; Ahmad Alrmih  <s86396@htw-dresden.de>; Eric Hübel <s86462@htw-dresden.de>
{localdatetime}
