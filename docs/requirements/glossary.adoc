...
| Komponenten
| Abgegrenzte Bausteine des Softwaresystems mit klarer Verantwortung und definierten Schnittstellen. Sie können unabhängig entwickelt, getestet und ausgetauscht werden
| Bauteile, Module
...
| Definierte Programmschnittstelle, über die Software-Komponenten interagieren

| SPA
| Single-Page-Application
| Webanwendung, die nach dem ersten Laden ohne vollständige Seiten-Reloads auskommt

| PWA
| Progressive Web App
| Web-App mit Offline-Fähigkeit und App-ähnlichem Nutzererlebnis
...
| VM
| Virtuelle Maschine
| Emulierte Computerumgebung, die Betriebssysteme isoliert ausführt

| UX
| User Experience
| Gesamterlebnis eines Nutzers bei der Interaktion mit einem Produkt

| HTTP
| Hypertext Transfer Protocol
| Standardprotokoll für die Übertragung von Daten im World Wide Web

| ORM
| Object-Relational Mapping
| Technik zur Abbildung von Objektmodellen auf relationale Datenbanken

| DB
| Datenbank
| Strukturierte Sammlung persistenter Daten, verwaltet durch ein Datenbankmanagementsystem

| UI
| User Interface
| Schnittstelle, über die Nutzer mit einem System interagieren
