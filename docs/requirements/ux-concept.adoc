...
- vertraut mit Clean-Code, Security-Prinzipien und agilen Methoden
- Fokus auf Benutzerfreundlichkeit, Skalierbarkeit und Wartbarkeit der Systeme

2+|*Bedürfnisse / Ziele*

2+|
- klare Anforderungen und Anwendungsfälle aller Features (muss klar Wissen, was er zu tun hat) 
