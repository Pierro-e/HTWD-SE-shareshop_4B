...
|image::../images/Persona(Niklas_Neumann).png[width=100%,alt="Persona2 Bild"]
|
...
|image::
|
* Stakeholdergruppe: Technoligie-Provider
* Alter: 35
* Geschlecht: männlich
* Familienstand: verheiratet
...
- sorgt für Skalirbarkeit, Ausfallsicherheit und Performance von Plattformdiensten 
...
- Einhaltung von Sicherheits- Datenschuttzstandarda in der Systemnutzung
- efiizient Fehlerbehebung 

2+|*Hindernisse / Frustrationen*

2+|
- unklare Verantworlichkeiten bei Systemproblemen (Dokumenatation darüber, wer welches System/Datenbank integriert hat)
