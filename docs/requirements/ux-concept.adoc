...
|image::images/Persona(Mark_Müller).png[width=40%,alt="Persona2 Bild"]
|
* Stakeholdergruppe: Nutzer
* Alter: 23
* Geschlecht: männlich
...
|image::images/Persona(Susi_Senn).png[width=40%,alt="Persona 3 Bild"]
|
* Stakeholdergruppe: Nutzer
* Alter: 24
* Geschlecht: weiblich
...
|image::images/Persona(Niklas_Neumann).png[width=40%,alt="Persona4 Bild"]
|
...
|image::images/Persona(Klara_Krüger).png[width=40%,alt="Persona5 Bild"]
|
...
|image::images/Persona(Tim_Tiedemann).png[width=40%,alt="Persona6 Bild"]
|
