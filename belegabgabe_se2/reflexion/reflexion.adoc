...
Prüfungen erfolgten vor allem manuell. Im Laufe des Semesters haben wir aber Coding Standards eingeführt (Styleguidelines) und Tests begonnen (automatische Tests sowie Tests mit gemockten Daten).
